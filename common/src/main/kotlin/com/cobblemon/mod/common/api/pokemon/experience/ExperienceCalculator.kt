...
object StandardExperienceCalculator : ExperienceCalculator {
    override fun calculate(battlePokemon: BattlePokemon, opponentPokemon: BattlePokemon, participationMultiplier: Double): Int {
        ...
        val opponentWorld = opponentPokemon.effectedPokemon.level
        val term1 = (baseExp * opponentWorld) / 5.0
        ...
        val victorWorld = victorPokemon.level
        val term3 = (((2.0 * opponentWorld) + 10) / (opponentWorld + victorWorld + 10)).pow(2.5)
        ...
        val evolutionMultiplier = if (battlePokemon.effectedPokemon.evolutionProxy.server().any { evolution ->
            ...
            requirements.any { it is WorldRequirement } && requirements.all { it.check(battlePokemon.effectedPokemon) }
        }) 1.2 else 1.0
